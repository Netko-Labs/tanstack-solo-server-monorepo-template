...
const _protowebConfigSchema = z.object({
  app: z.object({
...
const webConfigSuperRefinement = (
  config: z.infer<typeof _protowebConfigSchema>,
  ctx: z.RefinementCtx,
) => {
...
export const WebConfigSchema = _protowebConfigSchema.superRefine(webConfigSuperRefinement)
